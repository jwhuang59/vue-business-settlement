...
export default {
    ...
    methods: {
                ...
                allCityList.map((item,one) => {
                    ...
                    allCityList[one].cities.map((item,two) => {
                        ...
                        if(allCityList[one].cities[two].cities){
                            ...
                            this.cityList[one].children[two].children[0].regionId = allCityList[one].cities[two].regionId
                        }
        ...
        nextStep(){
            ...
            if(this.basicInfo.storeName === "" || this.basicInfo.storeName === undefined || this.basicInfo.storeName === null){
            ...
            }else if(this.basicInfo.province === "" || this.basicInfo.province === undefined || this.basicInfo.province === null){
                ...
                Dialog.confirm({
                    ...
                    this.$request("updateBasicInfo",this.basicInfo).then((res) => {
                        if(res.data){
                            Toast.success({
                                message:'保存成功',
                                duration:3000,
                            ...
                            setTimeout(() => {this.jump('finance');},3000)
