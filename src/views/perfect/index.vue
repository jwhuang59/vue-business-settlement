...
export default {
    ...
    methods:{
        ...
        nextStep(){
            ...
            if(this.perfectMenu[0].uploadPhotoMenu[0] === "" || this.perfectMenu[0].uploadPhotoMenu[0] === undefined || this.perfectMenu[0].uploadPhotoMenu[0] === null){
                Dialog.alert({message: '请上传法人健康证'});
                return false;

            }else if(this.perfectMenu[1].uploadPhotoMenu[0] === "" || this.perfectMenu[1].uploadPhotoMenu[0] === undefined || this.perfectMenu[1].uploadPhotoMenu[0] === null){
                Dialog.alert({message: '请上传门头照片'});
                return false;

            }else if(this.perfectMenu[2].uploadPhotoMenu[0] === "" || this.perfectMenu[2].uploadPhotoMenu[0] === undefined || this.perfectMenu[2].uploadPhotoMenu[0] === null){
